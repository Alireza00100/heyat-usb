...
<div class="container">
    ...
    <div class="content">
        <ul>
            <li><a class="links" href="{{route('archive.yearlist','محرم')}}">محرم</a> </li>
            <li><a class="links" href="{{route('archive.yearlist','فاطمیه')}}">فاطمیه</a> </li>
            <li><a class="links" href="{{route('archive.yearlist','شب های قدر')}}">شب های قدر</a> </li>
            <li><a class="links" href="{{route('archive.yearlist','اربعین')}}">اربعین</a> </li>
            <li><a class="links" href="{{route('archive.yearlist','هفتگی')}}">هفتگی</a> </li>
        </ul>
    </div>
